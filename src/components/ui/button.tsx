  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        cta: "bg-cta text-cta-foreground hover:bg-cta-hover shadow-cta hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0",
        ctaOutline: "border-2 border-cta text-cta hover:bg-cta hover:text-cta-foreground",
        hero: "bg-cta text-cta-foreground hover:bg-cta-hover shadow-cta hover:shadow-lg hover:-translate-y-1 active:translate-y-0 text-base px-8 py-6 rounded-xl",
      },
      size: {
